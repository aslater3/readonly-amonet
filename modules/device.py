from common import to_bytes, from_bytes
...
class Device:
    ...
    def handshake(self):
        ...
        reply = self.read(1)
        if reply and reply[0] == sequence[0]:
            log("Device already handshaken, skipping")
            return
